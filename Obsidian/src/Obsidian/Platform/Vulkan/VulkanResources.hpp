...
namespace Obsidian::Internal
{
    ...
    inline constexpr const auto g_ResourceStateMapping = std::to_array<ResourceStateMapping>({
        ...
        //{ ResourceState::AccelStructRead,   VK_PIPELINE_STAGE_2_RAY_TRACIOB_SHADER_BIT_KHR | 
    ...
    inline constexpr VkFilter FilterModeToVkFilter(FilterMode filter) { OB_ASSERT((static_cast<size_t>(filter) < g_FilterMapping.size()), "Filter exceeds mapping size."); return g_FilterMapping[static_cast<size_t>(filter)].VulkanFilter; }
    inline constexpr VkSamplerAddressMode SamplerAddressModeToVkSamplerAddressMode(SamplerAddressMode mode) { OB_ASSERT((static_cast<size_t>(mode) < g_SamplerAddressMapping.size()), "Mode exceeds mapping size."); return g_SamplerAddressMapping[static_cast<size_t>(mode)].VulkanSamplerAddressMode; }

    inline constexpr VkColorSpaceKHR ColourSpaceToVkColorSpaceKHR(ColourSpace space) { OB_ASSERT((static_cast<size_t>(space) < g_ColourSpaceMapping.size()), "Space exceeds mapping size."); return g_ColourSpaceMapping[static_cast<size_t>(space)].VulkanColorSpace; }
    ...
    inline constexpr VkAttachmentLoadOp LoadOperationToVkLoadOperation(LoadOperation operation) { OB_ASSERT((static_cast<size_t>(operation) < g_LoadOperationMapping.size()), "Operation exceeds mapping size."); return g_LoadOperationMapping[static_cast<size_t>(operation)].VulkanOperation; }
    inline constexpr VkAttachmentStoreOp StoreOperationToVkStoreOperation(StoreOperation operation) { OB_ASSERT((static_cast<size_t>(operation) < g_StoreOperationMapping.size()), "Operation exceeds mapping size."); return g_StoreOperationMapping[static_cast<size_t>(operation)].VulkanOperation; }
    ...
    inline constexpr VkPipelineBindPoint PipelineBindpointToVkBindpoint(PipelineBindpoint point) { OB_ASSERT((static_cast<size_t>(point) < g_PipelineBindpointMapping.size()), "Point exceeds mapping size."); return g_PipelineBindpointMapping[static_cast<size_t>(point)].VulkanBindpoint; }
    inline constexpr VkPrimitiveTopology PrimitiveTypeToVkPrimitiveTopology(PrimitiveType type) { OB_ASSERT((static_cast<size_t>(type) < g_PrimitiveTypeMapping.size()), "Type exceeds mapping size."); return g_PrimitiveTypeMapping[static_cast<size_t>(type)].VulkanPrimitiveType; }
    inline constexpr VkBlendFactor BlendFactorToVkBlendFactor(BlendFactor factor) { OB_ASSERT((static_cast<size_t>(factor) < g_BlendFactorMapping.size()), "Factor exceeds mapping size."); return g_BlendFactorMapping[static_cast<size_t>(factor)].VulkanBlendFactor; }
    inline constexpr VkBlendOp BlendOperationToVkBlendOp(BlendOperation operation) { OB_ASSERT((static_cast<size_t>(operation) < g_BlendOperationMapping.size()), "Operation exceeds mapping size."); return g_BlendOperationMapping[static_cast<size_t>(operation)].VulkanBlendOperation; }
    ...
    inline constexpr VkPolygonMode RasterFillModeToVkPolygonMode(RasterFillMode mode) { OB_ASSERT((static_cast<size_t>(mode) < g_RasterFillModeMapping.size()), "Mode exceeds mapping size."); return g_RasterFillModeMapping[static_cast<size_t>(mode)].VulkanPolygonMode; }
    inline constexpr VkCullModeFlags RasterCullingModeToVkCullModeFlags(RasterCullingMode mode) { OB_ASSERT((static_cast<size_t>(mode) < g_RasterCullingModeMapping.size()), "Mode exceeds mapping size."); return g_RasterCullingModeMapping[static_cast<size_t>(mode)].VulkanCullModeFlags; }

    inline constexpr VkStencilOp StencilOperationToVkStencilOp(StencilOperation operation) { OB_ASSERT((static_cast<size_t>(operation) < g_StencilOperationMapping.size()), "Operation exceeds mapping size."); return g_StencilOperationMapping[static_cast<size_t>(operation)].VulkanStencilOperation; }
    inline constexpr VkCompareOp ComparisonFuncToVkCompareOp(ComparisonFunc func) { OB_ASSERT((static_cast<size_t>(func) < g_ComparisonFuncMapping.size()), "Func exceeds mapping size."); return g_ComparisonFuncMapping[static_cast<size_t>(func)].VulkanCompareOperation; }

    inline constexpr VkDescriptorType ResourceTypeToVkDescriptorType(ResourceType type) { OB_ASSERT((static_cast<size_t>(type) < g_ResourceTypeMapping.size()), "Type exceeds mapping size."); return g_ResourceTypeMapping[static_cast<size_t>(type)].VulkanDescriptorType; }
    ...
    inline constexpr VkBorderColor Vec4ToBorderColor(const Obsidian::Maths::Vec4<float>& col)
    {
