...
#include "Obsidian/Platform/Dummy/DummyDevice.hpp"
...
namespace Obsidian
{
    ...
    public:
        using Type = Nano::Types::SelectorType<Information::RenderingAPI,
            Nano::Types::EnumToType<Information::Structs::RenderingAPI::Vulkan, Internal::VulkanDevice>,
            Nano::Types::EnumToType<Information::Structs::RenderingAPI::Dx12, Internal::Dx12Device>,
            Nano::Types::EnumToType<Information::Structs::RenderingAPI::Metal, Internal::DummyDevice>,
            Nano::Types::EnumToType<Information::Structs::RenderingAPI::Dummy, Internal::DummyDevice>
        >;
    public:
